...
import methodicalData from '/public/data/methodicaldata';
    ...
    return(
        <div className='flex flex-wrap text-left'>
            <div className='lg:basis-1/6 xl:basis-2/6 p-10 '>
              <Image src={methodicalLogo} className='w-20 h-auto' alt='Methodical Platforms' />  
              ...
              <div className='flex text-gray-700'>
                <div className='font-semibold rounded-full shadow-lg shadow-gray-300 p-4 cursor-pointer hover:scale-105 hover:text-cyan-500 ease-in duration-300'>
                  <a href="https://methodicalplatforms.com/" target="_blank" rel="noreferrer">Visit Site</a>
                </div>  
              </div>
            </div>
