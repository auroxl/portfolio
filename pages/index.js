          ...
          <nav className=" py-10 mb-12 flex justify-between">
            ...
            <ul className=' flex items-center'>              
              <li><a className=' bg-white text-gray-800 px-4 py-2 rounded-full shadow-lg shadow-gray-300 ml-8 font-semibold hover:text-cyan-500 ease-in duration-300'
               href="https://dev.jlgriffin.me/Jonathon_Griffin_Resume.pdf" target="_blank">Resume</a></li>
            </ul>
          </nav>
        ...
        <section>
          <div className='mt-10 pb-10 text-center'>
            <h4 className='text-2xl text-gray-700'>
              ...
              <span className='text-cyan-500'><a href="https://www.upwork.com/freelancers/~01131d9021bc943def" target="_blank"> visit</a></span>.
            </h4>
           ...
           <div className='mt-10'>
            <h4 className='text-2xl text-gray-700'>
                ...
                <span className='text-cyan-500'><a href="mailto:tiejgriffin@gmail.com" target="_blank"> tiejgriffin@gmail.com</a></span>.
              </h4>
           </div>
          </div>
        </section>
